...
static const uint cs_pin   = 1;  // Chip Select no GPIO 1
static const uint sck_pin  = 2;  // Clock no GPIO 2
static const uint mosi_pin = 3;  // MOSI no GPIO 3
static const uint miso_pin = 0;  // MISO no GPIO 0
